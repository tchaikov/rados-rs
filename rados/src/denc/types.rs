...
impl crate::denc::codec::FixedSize for UuidD {
    const SIZE: usize = 16;
}

impl crate::denc::codec::FixedSize for EVersion {
    const SIZE: usize = 12;
}

impl crate::denc::codec::FixedSize for UTime {
    const SIZE: usize = 8;
}
...
/// The `rados-auth` and `monclient` crates import this type directly.
///
/// For the OSD zero-copy packed format (9 bytes: u8 type + u64 num),
/// see `crate::osdclient::types::PackedEntityName`.
