...
use crate::denc::{Denc, UuidD};
use crate::monclient::error::Result;
use crate::monclient::paxos_service_message::{PaxosFields, PaxosServiceMessage};
use crate::monclient::subscription::{MonService, SubscribeItem};
use crate::msgr2::impl_denc_ceph_message;
...
/// Confirmation string required by the monitor for pool deletion.
/// The monitor rejects the request unless `name` equals this value.
pub const POOL_DELETE_CONFIRMATION: &str = "delete";
...
macro_rules! impl_paxos_ceph_message {
    ($type:ty, $msg_type:expr, $version:expr) => {
        impl_paxos_ceph_message!(@internal $type, $msg_type, $version,);
    };
    ($type:ty, $msg_type:expr, $version:expr, $compat:expr) => {
        impl_paxos_ceph_message!(@internal $type, $msg_type, $version, $compat);
    };
    (@internal $type:ty, $msg_type:expr, $version:expr, $($compat:expr)?) => {
        impl crate::msgr2::ceph_message::CephMessagePayload for $type {
            ...
            fn encode_payload(
                ...
                PaxosServiceMessage::encode(self)
                    .map_err(|e| crate::msgr2::Msgr2Error::Protocol(e.to_string()))
            }
            ...
            fn decode_payload(
                ...
                PaxosServiceMessage::decode(front).map_err(|e| {
                    crate::msgr2::Msgr2Error::Deserialization(format!(
                        "{} decode failed: {}",
                        stringify!($type),
                        e
                    ))
...
impl_denc_ceph_message!(MMonMap, crate::msgr2::message::CEPH_MSG_MON_MAP, 1);
...
impl_denc_ceph_message!(MConfig, crate::msgr2::message::CEPH_MSG_CONFIG, 1);
...
impl crate::msgr2::MapMessage for MOSDMap {
    const MSG_TYPE: u16 = crate::msgr2::message::CEPH_MSG_OSD_MAP;
    const NAME: &'static str = "MOSDMap";
}

impl crate::msgr2::ceph_message::CephMessagePayload for MOSDMap {
    fn msg_type() -> u16 {
...
impl PaxosServiceMessage for MMonCommand {
    ...
    fn decode_message(paxos: PaxosFields, data: &mut &[u8]) -> Result<Self> {
        ...
        let cmd = Vec::<String>::decode(data, 0)?;
...
impl crate::msgr2::ceph_message::CephMessagePayload for MMonCommand {
    fn msg_type() -> u16 {
        crate::msgr2::message::CEPH_MSG_MON_COMMAND
    }
    ...
    fn decode_payload(
        ...
        let mut cmd: MMonCommand = PaxosServiceMessage::decode(front).map_err(|e| {
            crate::msgr2::Msgr2Error::Deserialization(format!("MMonCommand decode failed: {e}"))
        })?;
...
impl MPoolOp {
    ...
    pub fn delete_pool(fsid: [u8; 16], pool: u32, version: u64) -> Self {
        Self {
            ...
            fsid: UuidD::from_bytes(fsid),
            pool,
            name: POOL_DELETE_CONFIRMATION.to_string(),
            op: POOL_OP_DELETE,
            snapid: 0,
            crush_rule: 0,
        }
...
impl_paxos_ceph_message!(MPoolOp, crate::msgr2::message::CEPH_MSG_POOLOP, 4, 2);
...
mod tests {
    ...
    fn test_mconfig_message_encoding() {
        ...
        assert_eq!(msg_type, crate::msgr2::message::CEPH_MSG_CONFIG);
