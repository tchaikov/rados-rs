...
pub use crate::msgr2::message::{
    CEPH_MSG_AUTH, CEPH_MSG_AUTH_REPLY, CEPH_MSG_PING, CEPH_MSG_PING_ACK,
};
...
pub struct CephMsgFooterOld {
    pub front_crc: crate::denc::zerocopy::little_endian::U32,
    pub middle_crc: crate::denc::zerocopy::little_endian::U32,
    pub data_crc: crate::denc::zerocopy::little_endian::U32,
    pub flags: u8,
}
...
/// kernel client). It is distinct from [`crate::msgr2::header::MsgHeader`], which is
...
pub struct CephMsgHeader {
    pub seq: crate::denc::zerocopy::little_endian::U64,
    pub tid: crate::denc::zerocopy::little_endian::U64,
    pub msg_type: crate::denc::zerocopy::little_endian::U16,
    pub priority: crate::denc::zerocopy::little_endian::U16,
    pub version: crate::denc::zerocopy::little_endian::U16,
    pub front_len: crate::denc::zerocopy::little_endian::U32,
    pub middle_len: crate::denc::zerocopy::little_endian::U32,
    pub data_len: crate::denc::zerocopy::little_endian::U32,
    pub data_off: crate::denc::zerocopy::little_endian::U16,
    pub src_type: u8,
    pub src_num: crate::denc::zerocopy::little_endian::U64,
    pub compat_version: crate::denc::zerocopy::little_endian::U16,
    pub reserved: crate::denc::zerocopy::little_endian::U16,
    pub crc: crate::denc::zerocopy::little_endian::U32,
}
...
impl CephMsgHeader {
    ...
    pub fn new(msg_type: u16, version: u16) -> Self {
        use crate::denc::zerocopy::little_endian::{U16, U32, U64};
        Self {
            seq: U64::new(0),
            tid: U64::new(0),
    ...
    pub fn calc_crc(&self) -> u32 {
        use crate::denc::zerocopy::IntoBytes;
...
impl CephMessage {
    ...
    pub fn from_payload<T: CephMessagePayload>(
        ...
        header.compat_version =
            crate::denc::zerocopy::little_endian::U16::new(T::msg_compat_version(features));
        header.front_len = crate::denc::zerocopy::little_endian::U32::new(front.len() as u32);
        header.middle_len = crate::denc::zerocopy::little_endian::U32::new(middle.len() as u32);
        header.data_len = crate::denc::zerocopy::little_endian::U32::new(data.len() as u32);
        ...
        if crc_flags.contains(CrcFlags::DATA) {
            footer.front_crc = crate::denc::zerocopy::little_endian::U32::new(crc32c(&front));
            footer.middle_crc = crate::denc::zerocopy::little_endian::U32::new(crc32c(&middle));
            footer.data_crc = crate::denc::zerocopy::little_endian::U32::new(crc32c(&data));
        } else {
            footer.flags |= MsgFooterFlags::NOCRC.bits();
        }

        if crc_flags.contains(CrcFlags::HEADER) {
            header.crc = crate::denc::zerocopy::little_endian::U32::new(header.calc_crc());
        }
...
/// Implement [`CephMessagePayload`] for a [`crate::Denc`]-derived type.
///
/// Generates boilerplate `encode_payload`/`decode_payload` for types whose
/// entire wire format is a straight Denc encode/decode.
///
/// # Variants
///
...
macro_rules! impl_denc_ceph_message {
    ($type:ty, $msg_type:expr, $version:expr) => {
        $crate::impl_denc_ceph_message!(@internal $type, $msg_type, $version,);
    };
    ($type:ty, $msg_type:expr, $version:expr, $compat:expr) => {
        $crate::impl_denc_ceph_message!(@internal $type, $msg_type, $version, $compat);
    };
    (@internal $type:ty, $msg_type:expr, $version:expr, $($compat:expr)?) => {
        impl $crate::msgr2::ceph_message::CephMessagePayload for $type {
            fn msg_type() -> u16 {
                $msg_type
            }
            ...
            fn encode_payload(
                &self,
                features: u64,
            ) -> std::result::Result<bytes::Bytes, $crate::Msgr2Error> {
                let size = $crate::Denc::encoded_size(self, features).unwrap_or(256);
                let mut buf = bytes::BytesMut::with_capacity(size);
                $crate::Denc::encode(self, &mut buf, features)?;
                Ok(buf.freeze())
            }
            ...
            fn decode_payload(
                ...
                _middle: &[u8],
                _data: &[u8],
            ) -> std::result::Result<Self, $crate::Msgr2Error> {
                let mut data = front;
                Ok($crate::Denc::decode(&mut data, 0)?)
            }
        }
    };
}
