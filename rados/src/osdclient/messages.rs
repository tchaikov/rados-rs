...
#[cfg(test)]
use crate::osdclient::types::OpData;
...
impl MOSDOp {
    ...
    pub fn new(
        ...
        Self {
            ...
            pgid,
            ops,
            snapid: crate::osdclient::types::SNAP_HEAD,
            snap_seq: 0,
            snaps: Vec::new(),
            reqid,
            global_id,
...
impl CephMessagePayload for MOSDOp {
    ...
    fn decode_payload(
        ...
        let _ = (front, data);
        Err(crate::msgr2::Msgr2Error::Deserialization(
    ...
    fn decode_payload(
        ...
        for i in 0..num_ops {
            if cursor.remaining() < CEPH_OSD_OP_SIZE {
                return Err(crate::msgr2::Msgr2Error::Deserialization(format!(
...
mod tests {
    ...
    fn test_mosdop_message_encoding() {
        ...
        let ops = vec![OSDOp {
            op: crate::osdclient::types::OpCode::Read,
            flags: 0,
    ...
    fn test_mosdop_with_write_data() {
        ...
        let ops = vec![OSDOp {
            op: crate::osdclient::types::OpCode::Write,
            flags: 0,
            op_data: OpData::Extent {
                offset: 0,
                length: 1024,
