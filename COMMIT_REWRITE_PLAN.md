...
**Approach**: Manual commit creation by *COPYING* source files from the original implementation located in the main branch into the new branch, one logical feature at a time.
...
For each commit:
- [ ] Copy from the "main" repo with minimal editing. 
