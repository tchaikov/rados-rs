...
use msgr2::io_loop::{KeepaliveConfig, run_io_loop};
...
impl MonConnection {
    ...
    pub async fn connect(params: MonConnectionParams) -> Result<Self> {
        ...
        tracing::debug!(
            ...
            (peer_supported_features & denc::features::CephFeatures::SERVER_JEWEL.bits()) != 0
        );
    ...
    pub fn supports_stateful_subscriptions(&self) -> bool {
        (self.peer_supported_features & denc::features::CephFeatures::SERVER_JEWEL.bits()) != 0
    }
