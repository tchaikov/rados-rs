        ...
        impl msgr2::ceph_message::CephMessagePayload for $type {
            ...
            fn encode_payload(
                ...
                PaxosServiceMessage::encode(self)
                    .map_err(|e| msgr2::Msgr2Error::Protocol(e.to_string()))
            }
            ...
            fn decode_payload(
                ...
                PaxosServiceMessage::decode(front).map_err(|e| {
                    msgr2::Msgr2Error::Deserialization(format!(
                        "{} decode failed: {}",
                        stringify!($type),
                        e
                    ))
...
impl msgr2::MapMessage for MOSDMap {
    const MSG_TYPE: u16 = msgr2::message::CEPH_MSG_OSD_MAP;
...
impl msgr2::ceph_message::CephMessagePayload for MMonCommand {
    ...
    fn encode_payload(&self, _features: u64) -> std::result::Result<Bytes, msgr2::Msgr2Error> {
        PaxosServiceMessage::encode(self).map_err(|e| msgr2::Msgr2Error::Protocol(e.to_string()))
    }
    ...
    fn decode_payload(
        ...
        let mut cmd: MMonCommand = PaxosServiceMessage::decode(front).map_err(|e| {
            msgr2::Msgr2Error::Deserialization(format!("MMonCommand decode failed: {e}"))
        })?;
