...
use denc::{Denc, HObject, RadosError, VersionedEncode};
use serde::Serialize;
...
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, denc::Denc)]
...
impl VersionedEncode for PgNlsResponse {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "PgNlsResponse", "Octopus v15+");
...
denc::impl_denc_for_versioned!(PgNlsResponse);

#[cfg(test)]
mod tests {
    use super::*;
    use bytes::BytesMut;
    use denc::{HObject, SNAP_HEAD};
