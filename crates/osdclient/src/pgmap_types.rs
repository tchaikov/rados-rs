...
impl VersionedEncode for ObjectStatSum {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 14, "ObjectStatSum", "Octopus v15+");
...
denc::impl_denc_for_versioned!(ObjectstorePerfStat);
...
impl VersionedEncode for PgStat {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 22, "PgStat", "Octopus v15+");
...
denc::impl_denc_for_versioned!(PgStat);
...
impl VersionedEncode for PgMapDigest {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "PgMapDigest", "Octopus v15+");
...
denc::impl_denc_for_versioned!(PgMapDigest);
