...
impl VersionedEncode for OsdXInfo {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "OsdXInfo", "Octopus v15+");
        // Version 1+ fields
...
impl VersionedEncode for PgPool {
    ...
    fn encoding_version(&self, features: u64) -> u8 {
        use denc::features::{CephFeatures, has_significant_feature};
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, Self::COMPAT_VERSION, "pg_pool_t", "Octopus v15+");
...
impl VersionedEncode for OSDMapIncrementalOsdSection {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "OSDMapIncremental::OsdSection", "Octopus v15+");
        let mut section = Self {
...
impl VersionedEncode for OSDMapClientSection {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "OSDMapClientSection", "Octopus v15+");
        let mut section = Self {
            fsid: UuidD::decode(buf, features)?,
            epoch: Epoch::decode(buf, features)?,
...
impl VersionedEncode for OSDMapOsdSection {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 1, "OSDMapOsdSection", "Octopus v15+");
        let mut section = Self {
...
impl OSDMapIncremental {
    ...
    pub fn decode_versioned<B: Buf>(buf: &mut B, features: u64) -> Result<Self, RadosError> {
        ...
        denc::check_min_version!(struct_v, 7, "OSDMapIncremental", "Octopus v15+");
...
impl VersionedEncode for OSDMap {
    ...
    fn decode_content<B: Buf>(
        ...
        denc::check_min_version!(version, 7, "OSDMap", "Octopus v15+");
